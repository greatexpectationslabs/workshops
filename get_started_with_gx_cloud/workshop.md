...
*This workshop content is current as of 11 August 2025.*
...
GX Cloud provides a tool to generate SQL based on a prompt. The prompt accepts plain language and will always generate a valid SQL query that will run correctly on your data. Alternatively, you can also write your own SQL statement if you'd like.
